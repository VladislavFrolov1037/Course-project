<div class="container mb-5">
    <ul class="nav nav-tabs" id="advertisementTabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link {{ $id === 1 ? 'active' : '' }}" id="all-ads-tab"
               href="{{ route('admin.meetings.index') }}" role="tab"
        ...
        <li class="nav-item">
            <a class="nav-link {{ $id === 2 ? 'active' : '' }}" id="pending-ads-tab"
               href="{{ route('admin.meetings.current') }}" role="tab"
