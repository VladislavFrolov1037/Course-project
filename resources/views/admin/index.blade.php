        ...
        <div class="row">
            ...
            <div class="user-management col-md-5">
                <a href="{{ route('admin.users.index') }}">
                    ...
                    <div class="user-count">Количество пользователей: 150</div>
                </a>
            </div>
            <div class="user-management col-md-5">
        ...
        <div class="row">
            ...
            <div class="user-management col-md-5">
                <a href="/admin/users">
                    ...
                    <div class="user-count">Количество новых встреч: 150</div>
                </a>
            </div>
            <div class="user-management col-md-5">
                <a href="/admin/users">
                    ...
                    <div class="user-count">Количество новых отзывов: 150</div>
                </a>
            </div>
            <div class="col-md"></div>
        </div>
        <div class="row">
            ...
            <div class="user-management col-md-5">
                <a href="/admin/users">
                    ...
                    <div class="user-count">Количество идей: 150</div>
                </a>
            </div>
            <div class="user-management col-md-5">
                <a href="/admin/users">
                    ...
                    <div class="user-count">Количество новых консультаций: 150</div>
                </a>
            </div>
            <div class="col-md"></div>
        </div>
