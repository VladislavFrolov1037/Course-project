...
@section('content')
    ...
    @include('admin.consultation.buttons', ['id' => 1])
    ...
    <div class="container">
        <table class="table">
            ...
            <tr>
                <th scope="col">#</th>
                <th scope="col"><a
                        href="{{ route('admin.consultations.index', ['sort' => 'name', 'order' => ($sort === 'name' && $order === 'asc' ? 'desc' : 'asc')]) }}">Имя</a>
                </th>
                <th scope="col"><a
                        href="{{ route('admin.consultations.index', ['sort' => 'email', 'order' => ($sort === 'email' && $order === 'asc' ? 'desc' : 'asc')]) }}">Почта</a>
                </th>
                <th scope="col">Телефон</th>
                <th scope="col"><a
                        href="{{ route('admin.consultations.index', ['sort' => 'date', 'order' => ($sort === 'date' && $order === 'asc' ? 'desc' : 'asc')]) }}">Дата
                        создания</a></th>
                <th scope="col"><a
                        href="{{ route('admin.consultations.index', ['sort' => 'status_id', 'order' => ($sort === 'status_id' && $order === 'asc' ? 'desc' : 'asc')]) }}">Статус</a>
                </th>
