...
@section('content')
    <div class="infoPage">
        <div class="path">
            <p class="link-primary"><a href="{{ route('main') }}">Главная</a> - Личный кабинет -
    ...
    <div class="register">
        <form class="custom-form" action="{{ route('register') }}" method="post" novalidate>
            ...
            <div class="form-group mb-2">
                ...
                <input type="email" class="form-control" id="exampleInputPassword1" name="email" placeholder="Почта">
            </div>
            <div class="form-group mb-2">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="exampleInputPassword1" name="password_confirmation" placeholder="Повторите пароль">
            </div>
