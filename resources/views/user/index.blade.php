                                ...
                                <a href="{{ route('advertisement.show', $advertisement->id) }}" class="product-link">
                                    <div class="card product-card">
                                        ...
                                        <div class="card-body product-details">
                                            <h4 class="card-title">г.{{ $advertisement->address->district->city->name }}
                                                ,
                                                улица {{ $advertisement->address->address }} {{ $advertisement->address->house_number }}</h4>
                                            <ul class="product-info">
                                                ...
                                                <li><img width="12" height="12"
                                                         src="{{ asset('assets/images/square.svg') }}" alt=""><strong>
                                                        Количество
                                                        комнат: </strong><span>{{ $advertisement->num_rooms }}</span>
                                                </li>
                                                <li><img width="12" height="12"
                                                ...
                                                <li><img width="14" height="14" style="fill: blue"
                                                        ...
                                                        Просмотрено: </strong><span>{{ $advertisement->views }} </span>
                                                </li>
                                                <li><img width="14" height="14" style="fill: blue"
                                                         src="{{ asset('assets/images/views.svg') }}" alt=""><strong>
